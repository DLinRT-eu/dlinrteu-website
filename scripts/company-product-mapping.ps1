...
$companyProducts = @{
    ...
    "Philips" = @("philips-auto-contouring", "philips-mrcat-head-and-neck", "philips-mrcat-brain", "philips-mrcat-pelvis", "philips-precise-image", "philips-smartspeed", "philips-smartspeed-precise", "philips-intellispace-ai-enhancement", "philips-smartdose-ct-enhancement")
