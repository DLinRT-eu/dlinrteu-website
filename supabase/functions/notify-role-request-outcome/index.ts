...
const getRoleDescription = (role: string): string => {
  switch (role) {
    ...
    case 'reviewer': return 'Reviewer access to evaluate and review product submissions';
    case 'company': return 'Company representative access to manage product certifications';
    default: return 'Access to additional platform features';
  }
};

const getRoleCapabilities = (role: string): string[] => {
  switch (role) {
    case 'admin': return ['Manage user accounts and roles', 'Assign review tasks to reviewers', 'Access security and analytics dashboards', 'Manage newsletter and communications'];
    case 'reviewer': return ['Review assigned products', 'Provide feedback on product submissions', 'Access reviewer dashboard', 'Manage your review workload'];
    case 'company': return ['Submit products for certification', 'Respond to reviewer feedback', 'Manage company product portfolio', 'Access certification status'];
    default: return ['Access platform features'];
  }
};
          ...
          <body style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, 'Helvetica Neue', Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
            ...
            <div style="background: #f9fafb; padding: 30px; border-radius: 0 0 10px 10px; border: 1px solid #e5e7eb; border-top: none;">
              ...
              <div style="text-align: center; margin: 30px 0;">
                <a href="${siteUrl}/dashboard" style="display: inline-block; background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); color: white; padding: 14px 32px; text-decoration: none; border-radius: 8px; font-weight: 600; font-size: 16px;">Go to Dashboard</a>
              </div>
              <div style="margin-top: 30px; padding-top: 20px; border-top: 1px solid #e5e7eb; color: #6b7280; font-size: 14px;">
                <p style="margin: 5px 0;"><strong>Need help?</strong> Contact us at <a href="mailto:info@dlinrt.eu" style="color: #667eea;">info@dlinrt.eu</a></p>
        ...
        <html>
          ...
          <body style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, 'Helvetica Neue', Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
            ...
            <div style="background: #f9fafb; padding: 30px; border-radius: 0 0 10px 10px; border: 1px solid #e5e7eb; border-top: none;">
              ...
              <div style="margin-top: 30px; padding-top: 20px; border-top: 1px solid #e5e7eb; color: #6b7280; font-size: 14px;">
                <p style="margin: 5px 0;"><strong>Questions?</strong> Contact us at <a href="mailto:info@dlinrt.eu" style="color: #667eea;">info@dlinrt.eu</a></p>
                <p style="margin: 5px 0; color: #9ca3af;">This is an automated notification from DLinRT.eu.</p>
              </div>
            </div>
          </body>
