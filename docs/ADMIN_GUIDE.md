...
| Period | Repository |
|--------|------------|
| April 2025 - September 2025 | `DLinRT-eu/dlinrteu-website` (original) |
...
## Newsletter — restoring lost subscribers

If the mailing list looks smaller than expected after a database migration:
