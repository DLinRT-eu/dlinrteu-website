...
export const SUN_NUCLEAR_SUNCHECK_ARCHIVED: ProductDetails[] = [
  {
    ...
    githubUrl: "https://github.com/DLinRT-eu/website/tree/main/src/data/products/performance-monitor/sun-nuclear.ts",
