...
// Archived: Intended use statement does not explicitly reference AI
export const RADFORMATION_CLEARCHECK_ARCHIVED: ProductDetails[] = [
  {
    ...
    githubUrl: "https://github.com/DLinRT-eu/website/tree/main/src/data/products/performance-monitor/radformation.ts",
