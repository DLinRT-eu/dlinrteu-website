...
export const MD_ANDERSON_PRODUCTS: ProductDetails[] = [
  {
    ...
    keyPapers: [
      ...
      {"doi":"10.1002/mp.17588","title":"An automated treatment planning portfolio for whole breast radiotherapy","authors":"Baroudi H et al.","journal":"Medical Physics","year":"2024","evidenceRigor":"E2","clinicalImpact":"I2","rationale":"End-to-end automated breast planning portfolio evaluated with collaborating centres in Argentina and Switzerland; dosimetric and workflow endpoints.","vendorIndependent":false,"multiCenter":true,"multiNational":true,"externalValidation":true},
    ...
    adoptionReadinessNotes: "Derived from E2 + FDA 510(k): mature peer-reviewed multi-center evidence with regulatory clearance; minor local commissioning and user training expected. Clinical deployment ongoing in LMICs.",
