...
export const MANTEIA_MOZI_PRODUCTS: ProductDetails[] = [
  {
    ...
    evidenceRigor: "E1",
    clinicalImpact: "I2",
    evidenceRigorNotes: "FDA K223724 validation (18 patients end-to-end, 187 patients auto-contouring). Limited independent publications.",
    clinicalImpactNotes: "Workflow improvement through AI-driven planning optimization and Monte Carlo dose calculation.",
