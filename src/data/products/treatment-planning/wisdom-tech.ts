...
export const WISDOM_TECH_PLANNING_PRODUCTS: ProductDetails[] = [
  {
    id: "wisdom-deep-plan",
    keyPapers: [
      {"doi":"10.1186/s13014-025-02742-4","pmid":"41219976","title":"Spiral volumetric modulated arc therapy for whole-brain radiotherapy with simultaneous integrated boost","authors":"Not stated","journal":"Radiation Oncology","year":"2025","link":"https://doi.org/10.1186/s13014-025-02742-4","evidenceRigor":"E1","clinicalImpact":"I1","rationale":"Planning-quality comparison using the commercial planning system.","vendorIndependent":true,"multiCenter":false,"prospective":false,"externalValidation":false},
      {"doi":"10.1186/s12885-026-16337-z","pmid":"42343259","title":"Spiral volumetric modulated arc therapy enhances peak-to-valley dose contrast for 3D-GRID radiotherapy","authors":"Not stated","journal":"BMC Cancer","year":"2026","link":"https://doi.org/10.1186/s12885-026-16337-z","evidenceRigor":"E1","clinicalImpact":"I1","rationale":"Planning-quality evaluation for GRID delivery.","vendorIndependent":true,"multiCenter":false,"prospective":false,"externalValidation":false}
    ],
    trainingData: {
    ...
    categoryEvidence: {
      ...
      "Auto-Contouring": {
        usesAI: true,
        notes: "Auto-delineation in DeepPlan is delivered by the vendor's sister product DeepContour. FDA K232928 clears DeepContour as a standalone product and does NOT cover DeepPlan; module-specific evidence (including K232928) is therefore tracked under the DeepContour entry, not here. No DeepPlan-specific contouring validation has been located.",
        evidenceRigor: "E0",
        evidenceRigorNotes: "No DeepPlan-specific contouring evidence located. K232928 (DeepContour) intentionally not cited here after 2026-06-15 audit because it does not name DeepPlan in its clearance scope.",
        clinicalImpact: "I0",
      },
    },
    name: "DeepPlan",
    ...
    source: "Vendor official product page (http://www.wisdom-tech.online/view-15.html); Wave 5 literature-expansion sweep 2026-08-25 (Europe PMC 2014-2026, alias-gated, DOIs verified against Crossref)",
    limitations: [
