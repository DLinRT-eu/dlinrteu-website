...
export const RAYSEARCH_PLANNING_PRODUCTS: ProductDetails[] = [
  {
    ...
    {"doi": "10.1002/acm2.14065", "title": "Automated treatment planning for proton pencil beam scanning using deep learning dose prediction and dose-mimicking optimization", "authors": "Maes D et al.", "journal": "J Appl Clin Med Phys", "year": "2023", "evidenceRigor": "E1", "clinicalImpact": "I2", "rationale": "Clinical validation of RayStation ML planning for proton PBS; RaySearch co-authors.", "vendorIndependent": false, "multiCenter": false, "multiNational": false, "prospective": false, "externalValidation": false},
    ...
    evidenceRigor: "E2",
    clinicalImpact: "I2",
    evidenceRigorNotes: "2026-09-23 HAIR cross-check: raised to E2. Verified peer-reviewed evaluations of the RayStation deep learning planning models now include a prospective blinded single-centre prostate evaluation (doi:10.1016/j.phro.2026.100999) and a multi-centre left-sided nodal breast evaluation (doi:10.1016/j.phro.2025.100839), plus single-centre breast, prostate and proton PBS studies. No randomised or multi-national prospective study, so E3 is not met. Earlier history: 2026-08-25 Wave 3 per-paper sweep: the previously cited \"Eriksson et al. Phys Med 2024 prostate dose prediction\" could not be verified — DOI 10.1016/j.ejmp.2024.103419 resolves to an unrelated digital breast tomosynthesis phantom study and no matching paper exists on PubMed or Crossref, so the citation was removed. Rad Oncol 2024 (doi:10.1186/s13014-024-02534-2) is a generic DL dose-calculation method paper and Nemoto 2025 evaluates the RatoGuide model with RayStation only as host TPS; both are indirect-comparative. No verified peer-reviewed evaluation of the RayStation deep learning planning models remains, so rigor is E0 (regulatory clearance K240398 and vendor model catalogue only). RayStation v2025 with ECHO algorithm (MSK). RayStation v2026 (July 2026) adds three new deep learning planning models: breast locoregional, lung proton, and prostate. Vendor states v2026 is subject to regulatory clearance in some markets and is not available for use or sale in USA/Canada; v2026 models therefore not factored into evidence scoring.",
    clinicalImpactNotes: "2026-09-23 HAIR cross-check: raised to I2. Published studies report dosimetric plan quality and planning-time endpoints; no patient-outcome data. Earlier history: 2026-08-25 Wave 3 per-paper sweep: no published dosimetric or workflow endpoint for the RayStation DL planning models survives verification, so impact is I0. Vendor claims workflow improvement through rapid automated plan generation with deep learning dose prediction; ECHO algorithm integration is claimed to further accelerate planning, but neither claim is independently published.",
    adoptionReadiness: "R3",
    adoptionReadinessNotes: "Derived from E2 + CE + FDA 510(k): moderate implementation effort — local validation, model commissioning and workflow confirmation required before adoption.",
    ...
    evidence: [
      ...
      {"type": "Peer-reviewed Publication", "description": "Maes D et al. Automated treatment planning for proton pencil beam scanning using deep learning dose prediction and dose-mimicking optimization. J Appl Clin Med Phys 2023. Clinical validation of RayStation ML planning for proton PBS; RaySearch co-authors. (Added 2026-09-23 from HAIR cross-check.)", "link": "https://doi.org/10.1002/acm2.14065"},
      {"type": "Peer-reviewed Publication", "description": "Neugebauer D et al. Prospective blinded clinical evaluation of a fully automated workflow for prostate radiotherapy. Phys Imaging Radiat Oncol 2026. Prospective blinded single-centre clinical evaluation of a fully automated prostate workflow in RayStation. (Added 2026-09-23 from HAIR cross-check.)", "link": "https://doi.org/10.1016/j.phro.2026.100999"},
      {
      ...
      },
      {
        ...
        description: "RaySearch Deep Learning Planning Model Catalogue (vendor document, not peer-reviewed)",
