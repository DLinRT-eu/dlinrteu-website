...
export const SUN_NUCLEAR_PRODUCTS: ProductDetails[] = [
  {
    ...
    description: "AI-powered treatment planning assistant that provides predictive, patient-specific insights on achievable dosimetric goals before planning begins. Uses machine learning models based on 5,000+ clinically delivered plans from Johns Hopkins University to drive continuous improvement in plan quality.",
    features: [
    ...
    diseaseTargeted: ["Prostate Cancer", "Head and Neck Cancer", "Thoracic Cancer", "Abdominal Cancer", "Pelvic Cancer"],
    keyFeatures: [
    ...
    regulatory: {
      ...
      intendedUseStatement: "Plan AI is intended to provide AI-powered dosimetric predictions and planning objectives for radiation therapy treatment planning. For use in the United States only."
    },
    market: {
    ...
    evidence: [
      ...
      },
      {
        ...
        link: "https://sunnuclear.com/about/news/sun-nuclear-acquires-oncospace"
      }
    ],
    limitations: [
