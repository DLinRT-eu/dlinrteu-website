...
export const PHILIPS_MRCAT_PELVIS_PRODUCTS: ProductDetails[] = [
  {
    ...
    keyPapers: [
      {"doi":"10.1002/acm2.12501","pmid":"30474353","title":"Dosimetric evaluation of an atlas-based synthetic CT generation approach for MR-only radiotherapy of pelvis anatomy","authors":"Farjam R, Tyagi N, Deasy JO, Hunt MA","journal":"Journal of Applied Clinical Medical Physics","year":"2019","link":"https://doi.org/10.1002/acm2.12501","evidenceRigor":"E1","clinicalImpact":"I1","rationale":"Wave 5A flagged paper, resolved 2026-08-25 from the open-access full text: the evaluated generator is an in-house multi-atlas method, but MRCAT is the commercial reference 'routinely used in our clinic' and is quantified alongside it (MAE 65 ± 5 HU whole image, 172 ± 9 HU bone; dosimetrically consistent). Recorded as a comparator evaluation of MRCAT on pelvis anatomy from prostate-cancer patients.","vendorIndependent":true,"multiCenter":false,"prospective":false,"externalValidation":false,"appliesToCategory":"Image Synthesis"},
