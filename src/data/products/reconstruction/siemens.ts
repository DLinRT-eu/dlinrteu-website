...
export const SIEMENS_PRODUCTS: ProductDetails[] = [
  {
    ...
    keyPapers: [
      ...
      {"doi":"10.1093/radadv/umaf029","title":"Deep learning MRI halves scan time and preserves image quality across routine neuroradiologic examinations","authors":"Lyo SK et al.","journal":"Radiology Advances","year":"2025","evidenceRigor":"E2","clinicalImpact":"I2","rationale":"Multi-site routine-practice evaluation showing halved acquisition time across neuroradiology protocols.","multiCenter":true}
    ],
    trainingData: {
