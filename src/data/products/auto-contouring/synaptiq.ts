...
export const MediqRT: ProductDetails = {
  ...
  // Structure list approximates the vendor-published counts (H&N 48+29 LN,
  // Thorax 37, Breast LN 25 + ESTRO 16, Abdomen 25, Pelvis 35+10 LN = 225 total).
  // Names are aligned with peer auto-contouring vocabularies (Limbus, MVision)
  // so the compare-structures matrix lines up; will be replaced with the
  // verbatim vendor catalogue when supplied. Abdominal entries remain
  // (unverified) until vendor confirmation.
  supportedStructures: [
    // ===== Head & Neck OARs (48) =====
    "Head & Neck: Brain",
    "Head & Neck: Brainstem",
    ...
    // ===== Breast Lymph Nodes — standard (25) =====
    "Breast: LN_Ax_L1_L",
    "Breast: LN_Ax_L1_R",
    "Breast: LN_Ax_L2_L",
    "Breast: LN_Ax_L2_R",
    ...
    "Breast: CTV_Boost_L",
    "Breast: CTV_Boost_R",
    // ===== Breast Lymph Nodes — ESTRO consensus (16) =====
    ...
    // ===== Abdomen OARs (25) — unverified pending vendor catalogue =====
