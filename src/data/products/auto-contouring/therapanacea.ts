...
export const Annotate: ProductDetails = {
  ...
  limitations: [
    ...
    // === Shared ART-Plan+ limitations (vendor technical information, therapanacea.eu/technical-information-2/) ===
    "Contours generated by ART-Plan+ must be verified and validated by an authorized user before clinical use",
    "Image-quality dependent: low-resolution, noisy, lossy-compressed, or artefact-laden CT volumes (e.g. implants) can degrade contour quality",
    "Adult patients only; auto-contouring may be inappropriate for paediatric volumes",
    "Auto-contouring may fail or produce inappropriate contours when DICOM tags Patient Position (0018,5100) or Patient Sex (0010,0040) are missing/incorrect, when the patient is not supine, for unusually high slice counts, or for post-surgical anatomy (e.g. prostatectomy)",
    "Pelvic and abdominal auto-contouring may produce inappropriate contours on CT images of patients under 60 years",
    "H&N lymph nodes, lacrimal glands and pharyngeal constrictor muscles: best performance on contrast-enhanced CT acquired on Siemens Sensation Open scanners and patients aged 50–79 years; degraded performance outside this envelope",
    "2D DICOM images (e.g. scout images) cannot be processed by the Annotate module",
...
export const TumorBox: ProductDetails = {
  ...
  limitations: [
    ...
    "Contours generated by ART-Plan+ must be verified and validated by an authorized user before any planning use",
    "Image-quality dependent: low-resolution, noisy, lossy-compressed, or artefact-laden volumes can degrade segmentation quality",
