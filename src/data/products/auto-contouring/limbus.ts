...
export const LIMBUS_PRODUCTS: ProductDetails[] = [
  {
    ...
    evidence: [
      {
        ...
        description: "An efficient automated approach for accumulated dose estimation in prostate cancer radiotherapy. Phys Imaging Radiat Oncol. 2026 (Limbus Contour v1.8.0 on CBCT)",
        link: "https://doi.org/10.1016/j.phro.2026.100942"
      },
    ...
    keyPapers: [
      {"doi": "10.1016/j.phro.2026.100942", "title": "An efficient automated approach for accumulated dose estimation in prostate cancer radiotherapy", "authors": "Grohmann M, Krug D, Baehr A, et al.", "journal": "Phys Imaging Radiat Oncol", "year": "2026", "evidenceRigor": "E1", "clinicalImpact": "I1", "rationale": "Full text checked 2026-09-25 (Europe PMC). Methods name Limbus Contour AI v1.8.0 for body, bladder, rectum and prostate contours on planning CT and daily CBCT in a dose-accumulation workflow; single-centre retrospective, no vendor co-authors or Limbus funding declared.", "vendorIndependent": true, "multiCenter": false, "multiNational": false, "prospective": false, "externalValidation": false},
