...
export const MIRADA_PRODUCTS: ProductDetails[] = [
  {
    ...
    evidence: [
      {
        ...
        description: "Vaassen F et al. Evaluation of measures for assessing time-saving of automatic organ-at-risk segmentation in radiotherapy. Phys Imaging Radiat Oncol. 2020;13:1-6 (prototype DLCexpert)",
        link: "https://doi.org/10.1016/j.phro.2019.12.001"
      },
    ...
    keyPapers: [
      {"doi": "10.1016/j.phro.2019.12.001", "title": "Evaluation of measures for assessing time-saving of automatic organ-at-risk segmentation in radiotherapy", "authors": "Vaassen F, Hazelaar C, Canters R, et al.", "journal": "Phys Imaging Radiat Oncol", "year": "2020", "evidenceRigor": "E1", "clinicalImpact": "I2", "rationale": "Full text checked 2026-09-25 (Europe PMC). Methods name prototype DLCexpert (Mirada Medical); single-centre lung OAR time-saving study (71% mean time saving vs 40% atlas). Mirada co-author, so not vendor-independent; prototype version.", "vendorIndependent": false, "multiCenter": false, "multiNational": false, "prospective": false, "externalValidation": false},
