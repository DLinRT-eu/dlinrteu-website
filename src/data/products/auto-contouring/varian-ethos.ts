...
export const VARIAN_ETHOS_PRODUCTS: ProductDetails[] = [
  {
    ...
    keyPapers: [
    {"doi":"10.1002/acm2.13399","title":"Ethos AI segmentation for online-adaptive RT","authors":"McCulloch J et al.","journal":"J Appl Clin Med Phys","year":"2021","evidenceRigor":"E1","clinicalImpact":"I1","rationale":"Single-centre technical evaluation of the online-adaptive segmentation step.","vendorIndependent":true},
    {"doi":"10.1016/j.phro.2020.12.004","title":"First clinical experience with Ethos","authors":"Sibolt P et al.","journal":"Phys Imag Radiat Oncol","year":"2021","evidenceRigor":"E2","clinicalImpact":"I3","rationale":"Prospective first clinical experience where AI contours drive online adaptive plan selection.","vendorIndependent":true,"prospective":true},
    ...
    {"doi":"10.1002/acm2.70067","title":"Ethos adaptive RT dosimetric evaluation","authors":"Kawula M et al.","journal":"J Appl Clin Med Phys","year":"2025","evidenceRigor":"E1","clinicalImpact":"I1","rationale":"Single-centre dosimetric evaluation of adaptive contours.","vendorIndependent":true}
  ],
