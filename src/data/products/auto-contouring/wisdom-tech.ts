...
export const WISDOM_TECH_PRODUCTS: ProductDetails[] = [
  {
    ...
    implementationBurdenNotes: "Derived from E0 + FDA 510(k): high implementation burden — limited independent evidence; structured pilot, expanded validation and human-factors testing recommended.",
    version: "2.0",
