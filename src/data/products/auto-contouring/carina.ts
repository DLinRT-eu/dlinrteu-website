...
export const CARINA_PRODUCTS: ProductDetails[] = [
  {
    ...
    supportedStructures: [
      ...
      "Head & Neck: Cerebellum (L/R) (investigational)",
      "Head & Neck: Cervical Spine (investigational)",
      "Head & Neck: Glottis, NRG Standard (investigational)",
      "Head & Neck: Neck Lymph Node Level III (L/R) (investigational)",
      "Head & Neck: Neck Lymph Node Level II (L/R) (investigational)",
      "Head & Neck: Neck Lymph Node Level IVa (L/R) (investigational)",
      "Head & Neck: Neck Lymph Node Level Ib (L/R) (investigational)",
    ...
    evidenceRigor: "E2",
    clinicalImpact: "I2",
    evidenceRigorNotes: "Kibudde et al., Adv Radiat Oncol 2024 - impact study in LMICs. Medical Physics Journal 2023 publication. ESTRO 2022 abstract. PubMed verified 2026-02-26.",
