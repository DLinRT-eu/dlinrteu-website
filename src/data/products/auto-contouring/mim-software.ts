...
export const MIM_SOFTWARE_PRODUCTS: ProductDetails[] = [
  {
    ...
    regulatory: {
      ...
      fda: {
        ...
        notes: "Cleared FDA version is 2.0.0 (Traditional 510(k) K253270, decision date 2026-03-27). Previous clearances: K250035 (2025-02-03), K213976 (Contour Prot00e9g00e9AI), K210632.",
      },
