...
export const RAYSEARCH_PRODUCTS: ProductDetails[] = [
  {
    ...
    keyPapers: [
      {"doi": "10.1016/j.phro.2023.100494", "title": "A geometry and dose-volume based performance monitoring of artificial intelligence models in radiotherapy treatment planning for prostate cancer", "authors": "De Kerf G, Claessens M, Raouassi F, et al.", "journal": "Phys Imaging Radiat Oncol", "year": "2023", "evidenceRigor": "E1", "clinicalImpact": "I1", "rationale": "Full text checked 2026-09-25 (Europe PMC). Methods name RSL Male Pelvic CT v1.0.0 (RaySearch) in RayStation 11B; single-network retrospective monitoring study; no competing interests declared.", "vendorIndependent": true, "multiCenter": false, "multiNational": false, "prospective": false, "externalValidation": false},
      {"doi": "10.1016/j.tipsro.2023.100211", "title": "Clinical evaluation of a deep learning segmentation model including manual adjustments afterwards for locally advanced breast cancer", "authors": "Bakx N, Rijkaart D, van der Sangen M, et al.", "journal": "Tech Innov Patient Support Radiat Oncol", "year": "2023", "evidenceRigor": "E1", "clinicalImpact": "I2", "rationale": "Full text checked 2026-09-25 (Europe PMC). Institution-trained model built in the RaySearch deep learning framework (RayStation 9B/10B); timed editing shows 42% (OAR) and 58% (CTV) time reduction. RaySearch research grant and training support acknowledged, so not vendor-independent.", "vendorIndependent": false, "multiCenter": false, "multiNational": false, "prospective": false, "externalValidation": false},
    ...
    evidence: [
      {
        ...
        description: "A geometry and dose-volume based performance monitoring of AI models in radiotherapy treatment planning for prostate cancer. Phys Imaging Radiat Oncol. 2023 (RSL Male Pelvic CT)",
        link: "https://doi.org/10.1016/j.phro.2023.100494"
      },
      {
        type: "Peer-reviewed Publication",
        description: "Clinical evaluation of a deep learning segmentation model including manual adjustments afterwards for locally advanced breast cancer. Tech Innov Patient Support Radiat Oncol. 2023 (RayStation deep learning framework)",
        link: "https://doi.org/10.1016/j.tipsro.2023.100211"
      },
