...
export const estro2026Announcements: NewsItem = {
  ...
  date: "2026-05-14",
  title: "ESTRO 2026: Vendor Announcements and Catalog Updates",
  summary:
    "Round-up of AI/DL-relevant announcements ahead of ESTRO 2026 (Stockholm, 15–19 May) from GE HealthCare, TheraPanacea, MIM Software, Spectronic Medical, RaySearch, United Imaging and Synaptiq, with the corresponding DLinRT.eu catalog updates.",
  content: `
ESTRO 2026 takes place in Stockholm from 15 to 19 May 2026. Several vendors have published pre-congress announcements relevant to AI in radiotherapy. Below is a neutral summary of the items that affect products already tracked in the DLinRT.eu catalog, along with the corresponding entry updates. Per the [product inclusion criteria](/about), only announcements with a clear AI/deep-learning component for radiotherapy are listed.
...
Highlights tracked in the catalog:
...
AI/DL components now tracked in the catalog:
...
## Post-ESTRO catalog updates (19 May 2026)
...
- **United Imaging uRT Auto-Contouring** and **uRT Auto-Planning**: kept in the catalog as integrated components of the CE-marked uRT-linac 506c. Notes and limitations tightened to make explicit that no model card, training-data description or standalone intended-use document has yet been published. The auto-contouring supported-structures section is now rendered as **"structure list unavailable"** rather than blank, since the vendor has not published a verified DICOM-conformant list.
...
The product previously listed above as **uCS-AI** (id \`united-ucs-ai\`, catalogued under [Image Enhancement](/products/image-enhancement)) has been **removed from the catalog**. No United Imaging or United Imaging Intelligence (UII) source — product pages, FDA 510(k) filings, the ESTRO 2026 microsite/press release, or the UII "AI Solutions for Healthcare" brochure — names a product called "uCS-AI." The uRT-linac 506c page explicitly describes its image-guidance chain as diagnostic **fan-beam CT (FBCT)**, not CBCT, and lists no matching feature; "uCS" (United Compressed Sensing) is a separate, MR-only brand unrelated to CT/CBCT. The entry appears to have combined that MR brand name with an "-AI" suffix and a CBCT-enhancement description that does not match either United Imaging radiotherapy system (uRT-linac 506c: FBCT; uRT-linac 306: hardware-based MV/kV CBCT, no associated AI software product identified). The genuine AI-assisted-compressed-sensing product, **uAIFI ACS**, is for **MR** and was already correctly tracked as **[uAIFI on uMR](/product/united-uaifi-umr)** under [Reconstruction](/products/reconstruction); no separate action was needed there. This correction also removes the dead \`united-ucs-ai\` reference from the United Imaging company record and from the ESTRO 2026 summary above. No replacement RT-CBCT-enhancement product was identified during this review (see audit note below); if/when United Imaging publishes a named, sourced product for that function, a new entry should be created following the standard contribution process.

---

If you spot another ESTRO 2026 announcement that should trigger a catalog update, please [contact us](/support).
`,
};
