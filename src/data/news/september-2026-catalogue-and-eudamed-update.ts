...
- **Structure counts are now distinct per vendor** across the dashboards and the [structure comparison](/compare/structures) page. Previously every model-specific entry was counted separately, which inflated the figures; the catalog now reports 2,733 organs at risk, 62 targets and 529 elective structures — including the full manufacturer-supplied organ list for [AccuContour](/product/manteia-accucontour) (397 CT and 91 MRI region-of-interest names, vendor-provided).
