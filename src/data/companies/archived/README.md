...
| Quanta Computer | Valid FDA K231855 but insufficient public documentation |
| Elekta (AATMA) | Valid FDA K212218 but insufficient public documentation |
| Varian (Siemens Healthineers) | Only product (Mobius3D) has no explicit AI reference in intended use |
