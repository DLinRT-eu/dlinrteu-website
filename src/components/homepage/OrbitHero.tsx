...
const OrbitHero = () => {
  ...
  return (
    <section className="relative overflow-hidden bg-white">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 md:px-8 pt-8 pb-12 md:pt-10 md:pb-20">

        {/* ── Orbit visualization ─────────────────────────────────────── */}
        <div className="relative mx-auto mt-6 md:mt-8 aspect-[16/10] max-w-5xl" style={{ containerType: "size" }}>
          <svg
