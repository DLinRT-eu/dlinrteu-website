                ...
                <div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
                    ...
                    <Button 
                      variant="outline" 
                      className="justify-start h-auto py-3"
                      onClick={() => navigate('/admin/pull-requests')}
                    >
                      <div className="flex items-start gap-3 w-full">
                        <GitPullRequest className="h-5 w-5 mt-0.5 flex-shrink-0" />
                        <div className="text-left flex-1">
                          <div className="font-semibold">GitHub PR Management</div>
                          <div className="text-xs text-muted-foreground mt-0.5">
                            Review and prioritize open pull requests
                          </div>
                        </div>
                      </div>
                    </Button>
                    ...
                    <Button
                      variant="outline"
                      className="justify-start h-auto py-3"
                      onClick={() => navigate('/admin/email-health')}
                    >
                      <div className="flex items-start gap-3 w-full">
                        <Mail className="h-5 w-5 mt-0.5 flex-shrink-0" />
                        <div className="text-left flex-1">
                          <div className="font-semibold">Email Health</div>
                          <div className="text-xs text-muted-foreground mt-0.5">
                            See delivery outcomes and blocked addresses
                          </div>
                        </div>
                      </div>
                    </Button>
                    ...
                    >
                      <div className="flex items-start gap-3 w-full">
                        ...
                        <div className="text-left flex-1">
                          ...
                          <div className="text-xs text-muted-foreground mt-0.5">
                            Add or remove income and expense entries
                          </div>
                        </div>
                      </div>
                    </Button>
